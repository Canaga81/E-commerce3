...
const Contact = () => {
    ...
    const send = async (e) => {
        ...
        const send = await fetch('https://react-edec5-default-rtdb.europe-west1.firebasedatabase.app/Message.json', option)
            ...
            <div className="container">
                <div className="form">
                    ...
                    <form method='POST'>
                        ...
                        <button onClick={send} type='sublit'>Send</button>
                    </form>
                </div>
            </div>
        </div>
